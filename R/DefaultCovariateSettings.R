...
createCovariateSettings <- function(useDemographicsGender = FALSE,
                                    ...
                                    useVisitCountMediumTerm = FALSE,
                                    useVisitCountShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPoLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByDeLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosPoLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosDeLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoPoLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoDeLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoPoDeLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosPoDeLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoPoLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoDeLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPoDeLongTerm = FALSE,
                                    useVisitOccurrenceRecordCountsMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPoMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByDeMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosPoMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosDeMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoPoMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoDeMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoPoDeMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosPoDeMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoPoMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoDeMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPoDeMediumTerm = FALSE,
                                    useVisitOccurrenceRecordCountsShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPoShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByDeShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosPoShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosDeShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoPoShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoDeShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoPoDeShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPosPoDeShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoPoShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByCoDeShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsByPoDeShortTerm = FALSE,
                                    useVisitOccurrenceRecordCountsInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPosInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByCoInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPoInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByDeInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPosPoInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPosDeInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoPoInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoDeInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPosCoPoDeInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPosPoDeInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByCoPoInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByCoDeInCohort = FALSE,
                                    useVisitOccurrenceRecordCountsByPoDeInCohort = FALSE,
                                    useVisitOccurrenceDayCountsLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPoLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByDeLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosPoLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosDeLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoPoLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoDeLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoPoDeLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosPoDeLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoPoLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoDeLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPoDeLongTerm = FALSE,
                                    useVisitOccurrenceDayCountsMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPoMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByDeMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosPoMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosDeMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoPoMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoDeMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoPoDeMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosPoDeMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoPoMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoDeMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPoDeMediumTerm = FALSE,
                                    useVisitOccurrenceDayCountsShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPoShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByDeShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosPoShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosDeShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoPoShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoDeShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoPoDeShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPosPoDeShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoPoShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByCoDeShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsByPoDeShortTerm = FALSE,
                                    useVisitOccurrenceDayCountsInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPosInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByCoInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPoInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByDeInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPosPoInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPosDeInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoPoInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoDeInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPosCoPoDeInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPosPoDeInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByCoPoInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByCoDeInCohort = FALSE,
                                    useVisitOccurrenceDayCountsByPoDeInCohort = FALSE,
                                    useDrugExposureRecordCountsLongTerm = FALSE,
                                    useDrugExposureRecordCountsMediumTerm = FALSE,
                                    useDrugExposureRecordCountsShortTerm = FALSE,
                                    useDrugExposureRecordCountsInCohort = FALSE,
                                    useDrugExposureDaysSupplyLongTerm = FALSE,
                                    useDrugExposureDaysSupplyMediumTerm = FALSE,
                                    useDrugExposureDaysSupplyShortTerm = FALSE,
                                    useDrugExposureDaysSupplyInCohort = FALSE,
                                    longTermStartDays = -365,
                                    mediumTermStartDays = -180,
                                    shortTermStartDays = -30,
                                    endDays = 0,
