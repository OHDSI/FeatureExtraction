{DEFAULT @covariate_id = CAST(YEAR(cohort_start_date) * 1000 + @analysis_id AS BIGINT)}
...
SELECT covariate_id,
	CAST(CONCAT ('index year: ', CAST((covariate_id - @analysis_id) / 1000 AS VARCHAR)) AS VARCHAR(512)) AS covariate_name,
